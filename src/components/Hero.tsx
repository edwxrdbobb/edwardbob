...
import EdwardKamara from "@/assets/ebk02.jpg"; 
// import NueralDemo from "./demos/neural-network-bg";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative group">
              ...
              <div className="relative w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden border-4 border-primary/20 shadow-3d-lg transition-all duration-500 group-hover:shadow-3d-lg group-hover:scale-105">
                <ImageWithFallback
                  ...
                  className="w-full h-full object-cover object-filter grayscale"
                />
                {/* 3D Gradient overlay */}
          ...
          <div className="order-1 lg:order-2 text-center lg:text-left space-y-8">
            <div className="space-y-6 ">
              ...
              <h2 className="text-xl md:text-2xl lg:text-3xl text-muted-foreground font-offside ">
