...
export function Contact() {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      username: "in/edwardbob",
    },
    {
      icon: MessageCircle,
      label: "Discord",
      href: "https://discord.com",
      username: "edwardbob#1337",
    },
  ]

  return (
    <section className="py-20 px-4 relative overflow-hidden">
      <GridPattern width={60} height={60} maxOpacity={0.1} numSquares={30} className="absolute inset-0" />
              ...
              <div className="space-y-4">
                {contactInfo.map((contact) => {
                  ...
                  return (
                    <div
                      key={contact.label}
                      className="flex items-center space-x-4 p-4 rounded-lg border bg-card card-3d"
                    >
              ...
              <div className="space-y-3">
                {socialLinks.map((social) => {
                  ...
                  return (
                    <div
                      key={social.label}
                      className="flex items-center justify-between p-4 rounded-lg border bg-card card-3d"
                    >
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="message" placeholder="Tell me about your project..." rows={5} className="resize-none" />
                </div>
