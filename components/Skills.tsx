    ...
    <section className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl mb-4 font-bold">Skills & Technologies</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {skillCategories.map((category) => {
            ...
            return (
              <GlareCard key={category.title}>
                <Card className="border-0 overflow-hidden relative h-full">
                  ...
                  <CardHeader className="text-center pb-4">
                    ...
                    <div className="text-sm text-muted-foreground">{category.level}% Proficiency</div>
                  </CardHeader>
